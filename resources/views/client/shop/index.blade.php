                        ...
                        <div class="col-12 col-sm-8 text-center text-sm-left">
                            <div class="toolbar-sorter-right">
                                ...
                                <select id="basic" class="selectpicker show-tick form-control" data-placeholder="$ USD">
                                    <option value="?sort=popular">Phổ biến</option>
                                    <option value="?sort=price_desc">Giá từ cao đến thấp</option>
                                    <option value="?sort=price_asc">Giá từ thấp đến cao</option>
                                    <option value="?sort=best_selling">Hàng bán chạy</option>
                                </select>
                            </div>
                        </div>
                                                ...
                                                <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                                    <div class="products-single fix">
                                                        <div class="box-img-hover">
                                                            ...
                                                            <img src="{{asset('images/'.$item->image)}}" class="img-fluid" style="width: 250px; height: 200px;" alt="Image">
                                                            <div class="mask-icon">
                                                                <ul>
                                                        ...
                                                        <div class="why-text" style="display: flex; justify-content: space-between;">
                                                            <div>
                                                                <h4>{{$item->name}}</h4>
                                                            ...
                                                            <div>
                                                                <a 
                                                                    href="{{route('show_detail', $item->id)}}" 
                                                                    data-toggle="tooltip" data-placement="right" title="Xem" style="font-size: 35px;"><i class="fas fa-eye"></i></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
